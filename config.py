...
class Config:
    ...
    SECRET_KEY = os.getenv("SECRET_KEY", "carehub-super-secret-production-key-2026")
    JWT_SECRET_KEY = os.getenv("JWT_SECRET_KEY", "carehub-jwt-token-signing-secret-2026")
    ...
    HOSPITAL_EMAIL = "care@carehub.in"
    HOSPITAL_WEBSITE = "https://www.carehub.in"
    ...
    MYSQL_DB = os.getenv("MYSQL_DB", "carehub_db")
    
    # SQLite local DB fallback file
    SQLITE_DB_PATH = os.path.join(os.path.dirname(__file__), "database", "carehub.sqlite")
