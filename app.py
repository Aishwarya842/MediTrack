...
def init_sqlite_db():
    ...
    if not cursor.fetchone():
        ...
        CREATE TABLE IF NOT EXISTS medicines (
            ...
            stock_quantity INTEGER NOT NULL DEFAULT 10000,
        ...
        # Seed Medicines
        medicines_data = [
            (1, 'Dolo 650 Tablet', 'Paracetamol', 'Dolo 650', 'Analgesics', 'Micro Labs Ltd', '650 mg', 'Tablet', 2.10, 10000, 200, 'DL-2026-081', '2028-06-30', '3004', 'Antipyretic and analgesic for fever, acute body aches, and post-viral myalgia.'),
            (2, 'Augmentin 625 Duo Tablet', 'Amoxicillin + Clavulanic Acid', 'Augmentin 625 Duo', 'Antibiotics', 'GlaxoSmithKline Pharmaceuticals', '500mg + 125mg', 'Tablet', 22.40, 10000, 80, 'AUG-2026-X19', '2027-11-30', '3004', 'Broad-spectrum beta-lactamase resistant antibiotic for respiratory, ENT, and soft tissue infections.'),
            (3, 'Pan-D Capsule', 'Pantoprazole + Domperidone', 'Pan-D', 'Gastrointestinal', 'Alkem Laboratories', '40mg + 30mg SR', 'Capsule', 16.80, 10000, 100, 'PND-2026-88', '2028-03-31', '3004', 'Proton pump inhibitor with prokinetic agent for GERD, acid reflux, and hyperacidity.'),
            (4, 'Telma 40 Tablet', 'Telmisartan', 'Telma 40', 'Cardiology', 'Glenmark Pharmaceuticals', '40 mg', 'Tablet', 11.20, 10000, 120, 'TLM-2026-44', '2028-01-31', '3004', 'Angiotensin II receptor blocker (ARB) for essential hypertension and cardiac risk reduction.'),
            (5, 'Glycomet-GP 2 Tablet', 'Metformin + Glimepiride', 'Glycomet-GP 2', 'Antidiabetic', 'USV Private Limited', '500mg + 2mg', 'Tablet', 14.50, 10000, 150, 'GLY-2026-92', '2027-10-31', '3004', 'Dual action oral hypoglycaemic agent for Type 2 Diabetes Mellitus control.'),
            (6, 'Ecosprin 75 Tablet', 'Aspirin', 'Ecosprin 75', 'Cardiology', 'USV Private Limited', '75 mg', 'Tablet', 0.85, 10000, 100, 'ECO-2026-03', '2028-09-30', '3004', 'Antiplatelet agent for prevention of heart attack and stroke.'),
            (7, 'Atorva 10 Tablet', 'Atorvastatin', 'Atorva 10', 'Cardiology', 'Zydus Cadila', '10 mg', 'Tablet', 9.80, 10000, 100, 'ATV-2026-11', '2028-04-30', '3004', 'HMG-CoA reductase inhibitor (statin) for hypercholesterolemia and plaque stabilization.'),
            (8, 'Montek-LC Tablet', 'Montelukast + Levocetirizine', 'Montek-LC', 'Respiratory', 'Sun Pharma', '10mg + 5mg', 'Tablet', 19.50, 10000, 80, 'MLC-2026-77', '2027-12-31', '3004', 'Leukotriene receptor antagonist with antihistamine for allergic rhinitis and asthma.'),
            (9, 'Clexane 40mg Injection', 'Enoxaparin Sodium', 'Clexane 40mg', 'Cardiology', 'Sanofi India', '40mg / 0.4ml', 'Injection', 495.00, 10000, 50, 'CLX-2026-01', '2027-08-31', '3004', 'Low molecular weight heparin for prevention and treatment of deep vein thrombosis.'),
            (10, 'Neurobion Forte Tablet', 'Vitamin B-Complex + B12', 'Neurobion Forte', 'Neurology', 'Procter & Gamble Health', 'Multi-B', 'Tablet', 3.80, 10000, 200, 'NBF-2026-62', '2028-05-31', '3004', 'High-potency vitamin B formulation for peripheral neuropathy and nerve health.'),
            (11, 'Azithral 500 Tablet', 'Azithromycin', 'Azithral 500', 'Antibiotics', 'Alembic Pharmaceuticals', '500 mg', 'Tablet', 28.00, 10000, 60, 'AZT-2026-15', '2028-02-28', '3004', 'Macrolide antibiotic for atypical pneumonia, throat infections, and sinusitis.'),
            (12, 'Shelcal 500 Tablet', 'Calcium Carbonate + Vitamin D3', 'Shelcal 500', 'Neurology', 'Torrent Pharmaceuticals', '500mg + 250 IU', 'Tablet', 9.50, 10000, 150, 'SHL-2026-33', '2028-07-31', '3004', 'Elemental calcium with cholecalciferol for bone mineralization, osteoporosis, and pregnancy.'),
            (13, 'Ciplox 500 Tablet', 'Ciprofloxacin', 'Ciplox 500', 'Antibiotics', 'Cipla Ltd', '500 mg', 'Tablet', 8.50, 10000, 100, 'CIP-2026-41', '2028-06-30', '3004', 'Fluoroquinolone antibiotic for urinary tract and gastrointestinal bacterial infections.'),
            (14, 'Combiflam Tablet', 'Ibuprofen + Paracetamol', 'Combiflam', 'Analgesics', 'Sanofi India', '400mg + 325mg', 'Tablet', 5.20, 10000, 180, 'CBF-2026-22', '2028-08-31', '3004', 'Non-steroidal anti-inflammatory and pain reliever for musculoskeletal sprains and toothaches.'),
            (15, 'Foracort 200 Inhaler', 'Budesonide + Formoterol', 'Foracort 200', 'Respiratory', 'Cipla Ltd', '200 mcg + 6 mcg', 'Inhaler', 485.00, 10000, 20, 'FRC-2026-09', '2027-09-30', '3004', 'Maintenance meter-dose inhaler for bronchial asthma and chronic obstructive pulmonary disease.'),
            (16, 'Betadine 10% Solution', 'Povidone Iodine', 'Betadine', 'Respiratory', 'Win-Medicare', '10% w/v', 'Drops', 145.00, 10000, 40, 'BTD-2026-55', '2028-11-30', '3004', 'Topical microbicidal antiseptic for pre-operative skin disinfection and minor wound care.'),
            (17, 'Ciplox Eye/Ear Drops', 'Ciprofloxacin 0.3%', 'Ciplox Drops', 'Respiratory', 'Cipla Ltd', '0.3% w/v', 'Drops', 24.00, 10000, 50, 'CIPD-2026-07', '2028-04-30', '3004', 'Sterile ophthalmic/otic antibacterial drops for conjunctivitis and external ear canal infection.'),
            (18, 'Inj. Tramadol 100mg', 'Tramadol Hydrochloride', 'Tramazac', 'Analgesics', 'Zydus Cadila', '50 mg/ml (2ml)', 'Injection', 45.00, 10000, 30, 'TRM-2026-18', '2027-07-31', '3004', 'Centrally acting synthetic opioid analgesic for moderate to severe acute postoperative pain.'),
            (19, 'Inj. Ondansetron 4mg', 'Ondansetron HCl', 'Emeset 2ml', 'Gastrointestinal', 'Cipla Ltd', '2 mg/ml', 'Injection', 28.00, 10000, 40, 'OND-2026-26', '2028-01-31', '3004', 'Serotonin 5-HT3 receptor antagonist for acute nausea & vomiting.'),
            (20, 'Livogen Adult Tonic', 'Ferrous Fumarate + Folic Acid', 'Livogen Tonic', 'Neurology', 'Merck / P&G', 'Ferrous 150mg + Folic 0.5mg', 'Syrup', 165.00, 10000, 30, 'LIV-2026-44', '2028-03-31', '3004', 'Hematinic tonic for iron deficiency anaemia, pregnancy nutrition, and general debility.')
        ]
        cursor.executemany("INSERT INTO medicines (id, medicine_name, generic_name, brand_name, category, manufacturer, strength, form, unit_price, stock_quantity, reorder_level, batch_number, expiry_date, hsn_code, description) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", medicines_data)
...
def migrate_sqlite_db():
    """Ensure new columns exist in existing databases (schema migration)."""
    try:
        conn = sqlite3.connect(Config.SQLITE_DB_PATH)
        cursor = conn.cursor()
        # Check if medicines table exists and has batch_number column
        med_cols = cursor.execute("PRAGMA table_info(medicines)").fetchall()
        col_names = {c[1] for c in med_cols}
        if med_cols and "batch_number" not in col_names:
            cursor.execute("ALTER TABLE medicines ADD COLUMN batch_number TEXT")
        if med_cols and "expiry_date" not in col_names:
            cursor.execute("ALTER TABLE medicines ADD COLUMN expiry_date TEXT")
        if med_cols and "hsn_code" not in col_names:
            cursor.execute("ALTER TABLE medicines ADD COLUMN hsn_code TEXT DEFAULT '3004'")
        conn.commit()
        conn.close()
...
def api_update_medicine(med_id):
    ...
    new_stock = int(data.get("stock_quantity", med["stock_quantity"]))
    
    db.execute("""
        UPDATE medicines SET
            medicine_name = ?, generic_name = ?, brand_name = ?, category = ?,
            manufacturer = ?, strength = ?, form = ?, unit_price = ?,
            stock_quantity = ?, reorder_level = ?, batch_number = ?,
            expiry_date = ?, hsn_code = ?, description = ?
        WHERE id = ?
    """, (
        data.get("medicine_name", med["medicine_name"]),
        data.get("generic_name", med["generic_name"]),
        data.get("brand_name", med["brand_name"]),
        data.get("category", med["category"]),
        data.get("manufacturer", med["manufacturer"]),
        data.get("strength", med["strength"]),
        data.get("form", med["form"]),
        float(data.get("unit_price", med["unit_price"])),
        new_stock,
        int(data.get("reorder_level", med["reorder_level"])),
        data.get("batch_number", med["batch_number"]),
        data.get("expiry_date", med["expiry_date"]),
        data.get("hsn_code", med["hsn_code"]),
        data.get("description", med["description"]),
        med_id
    ))
    db.commit()
    log_audit("UPDATE_MEDICINE", "INVENTORY", f"Updated medicine ID {med_id} stock to {new_stock}")
...
def api_create_prescription():
    ...
    for med in medicines:
        ...
        if med.get("medicine_id"):
            ...
            # Auto-refill: if stock hits 0, replenish to 10000
            stock_row = db.execute("SELECT stock_quantity FROM medicines WHERE id = ?", (med.get("medicine_id"),)).fetchone()
            if stock_row and stock_row["stock_quantity"] == 0:
                db.execute("UPDATE medicines SET stock_quantity = 10000 WHERE id = ?", (med.get("medicine_id"),))
                log_audit("AUTO_REFILL", "INVENTORY", f"Stock for medicine ID {med.get('medicine_id')} reached 0. Auto-refilled to 10000 units.")
